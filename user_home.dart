...
class MyApp extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                const Row(
                  children: [
                    ...
                    CircleAvatar(
                      ...
                      backgroundImage: NetworkImage('assets/OIP (4).jpg'),
                    ),
                    SizedBox(width: 10.0),
                    Text(
                      'Hello, user',
                ...
                ElevatedButton(
                  ...
                  style: ButtonStyle(
                    backgroundColor: MaterialStateProperty.all<Color>(const Color.fromARGB(255, 12, 12, 12)),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: const DecorationImage(
                            image: NetworkImage('assets/R (5).jpg'),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
                ...
                const SizedBox(height: 10.0), // Add some space between the two texts
                const Text(
                                    ...
                                    Row(
                                      children: [
                                        Icon(
                                          Icons.circle,
                                          size: 12.0,
                                          color: Colors.green, // Online status indicator color
                                        ),
                                        SizedBox(width: 2.0),
                                        Text(
  ...
  child: SizedBox(
    ...
    height: 150,
    child: Image.network(
      'assets/OIP (6).jpg', // Placeholder image URL
      fit: BoxFit.cover,
    ),
  ),
),
const Column(
  ...
  items: const <BottomNavigationBarItem>[
    ...
    BottomNavigationBarItem(
      icon: Icon(Icons.message), // Changed to email icon
      label: 'Message',
    ),
    BottomNavigationBarItem(
  ...
  selectedItemColor: const Color.fromARGB(255, 102, 103, 104), // Set the color of the selected item
