...
import 'package:skill_swap/User/homepage.dart';
import 'package:skill_swap/sign_in.dart';
import 'package:skill_swap/Project/projectcontroller.dart';
import 'package:skill_swap/Project/userdata.dart';
import 'package:skill_swap/firebase.dart';
import 'package:skill_swap/widget/skillsdropdown.dart';
import 'package:skill_swap/User/homepage.dart';
  ...
  void _signUp() async {
    ...
    try {
      ...
      if (user != null) {
        ...
        _showSnackBar(
            "User is successfully created. Please verify your email.");
      } else {
        print("Some error happened while creating the user");
        _showSnackBar("Some error happened while creating the user");
      }
    } catch (e) {
